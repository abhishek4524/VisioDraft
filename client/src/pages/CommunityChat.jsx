  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const communityRes = await axios.get(`${backendUrl}/api/community/view/${id}`, {
          headers: { Authorization: `Bearer ${token}` }
        });
      ...
      >
        <div className='p-5 border-b border-gray-200 flex justify-between items-center bg-white'>
          <div className="flex items-center gap-3">
            <img src={assets.logo} alt="VisioDraft Logo" className='h-10 transition-transform hover:scale-105 duration-300'/>
          </div>
          <button 
      ...
      <div className="flex-1 p-4 lg:p-6 py-16 lg:py-6">
        {error ? (
          ...
          <div className="bg-white h-screen rounded-2xl shadow-sm p-4 sm:p-6 md:p-8 lg:p-8 w-full max-w-6xl mx-auto flex flex-col">
            <div className="flex flex-col md:flex-row md:items-center gap-4 mb-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 mt-1 text-sm md:text-base">{community.description || "Community discussion"}</p>
          ...
          <div className="text-center py-12 max-w-4xl mx-auto bg-white rounded-2xl shadow-sm p-6 mt-4">
            ...
            <h3 className="text-xl font-medium text-gray-700 mb-2">Community not found</h3>
            <p className="text-gray-500 mb-6 max-w-md mx-auto">The community you're looking for doesn't exist or you don't have access to it.</p>
            <button 
