...
const NoteCard = ({ data }) => {
  ...
  return (
    <div className='bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden border border-gray-200 hover:border-blue-200 group transform hover:-translate-y-1'>
      <div className='p-5'>
        <div className='flex justify-between items-start mb-3'>
          <div>
            <span className={`inline-flex items-center px-2.5 py-1 text-xs font-medium rounded-full mb-2 ${
            ...
            <h3 className='font-semibold text-lg text-gray-900 mb-1 group-hover:text-blue-600 transition line-clamp-2'>
              {data.title}
            </h3>
            {data.subject && (
        ...
        <div className='flex justify-between items-center pt-3 border-t border-gray-100'>
          ...
          <div className='flex items-center space-x-3'>
            ...
            >
              Download
              <FiDownload className='h-4 w-4 ml-1' />
            </button>
          </div>
        </div>
      </div>
